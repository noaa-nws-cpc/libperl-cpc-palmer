...
=head1 README for the CPC::Palmer module
...
This README file provides instructions on how to install the module on your system. For documentation on using the CPC::Palmer module itself, see L<CPC::Palmer|https://github.com/noaa-nws-cpc/libperl-cpc-palmer/blob/main/docs/CPC/Palmer.pod>.
...
To install the most up-to-date code, clone the GitHub repository.
        ...
        git clone git@github.com:noaa-nws-cpc/libperl-cpc-palmer.git
